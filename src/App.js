...
const App = () => {
  ...
  const [input, setInput] = useState({
    ...
    soil_quality: '', moisture: '', temperature: '', actual_yield: ''
  });
  ...
  return (
    <div style={appStyle}>
      ...
      <p style={subheadingStyle}>Enter soil parameters to predict its fertility</p>
      ...
      <div style={cardStyle}>
                    ...
                    {fields.map((field) => (
                      <div key={field}>
                        ...
                        <input
                          ...
                          style={category === "Main Parameters" ? inputStyle : smallInputStyle}
        ...
        {prediction && (
          ...
          <div>
            <span><strong>Fertility Grade:</strong> {prediction.grade_fertility}</span>
          </div>
          <div>
            <span><strong>Recommended Fertilizer:</strong> {prediction.recommended_fertilizer}</span>
          </div>
          <div>
            <span><strong>Predicted Yield:</strong> {prediction.predicted_yield}</span>
          </div>
        </div>
        )}
      </div>
